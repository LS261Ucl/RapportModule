...
namespace Rapport.Shared.Services
{
    public class ModalService : IModalService
    {
        ...
        public IModalReference Show(Type contentComponent, string title, ModalParameters parameters, ModalOptions options)
        {
            ...
            {
                builder.OpenComponent<Blazored.Modal.BlazoredModalInstance>(0);
                ...
                builder.AddComponentReferenceCapture(5, compRef => modalReference!.ModalInstanceRef = (Blazored.Modal.BlazoredModalInstance)compRef);
                builder.CloseComponent();
            });
         //   modalReference = new Configuration.ModalReference(modalInstanceId, modalInstance, this);
